...
import com.example.demo.domain.users.SimpleLoginUser;
import com.example.demo.usecase.repository.UserRepository;
...
public class SimpleUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) { 
        ...
        return userRepository.findByEmail(email).map(SimpleLoginUser::new)
